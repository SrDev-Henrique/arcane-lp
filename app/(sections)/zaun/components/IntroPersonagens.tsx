...
const IntroPersonagens = () => {
  ...
  return (
    <div
      ...
      className="h-[50lvh] sm:h-[85lvh] md:h-[95lvh] lg:h-[120lvh] xl:h-[175lvh] w-full flex gap-[1dvw] px-[1dvw] relative rounded-3xl bg-zaun-sageGreen overflow-hidden filter brightness-75"
    >
