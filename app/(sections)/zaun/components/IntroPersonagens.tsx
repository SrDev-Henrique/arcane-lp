...
const IntroPersonagens = () => {
  ...
  return (
    <div
      ...
      className="h-[50dvh] sm:h-[85dvh] md:h-[120dvh] xl:h-[175dvh] w-full flex gap-[1vw] px-[1vw] relative rounded-3xl bg-zaun-sageGreen overflow-hidden filter brightness-75"
    >
